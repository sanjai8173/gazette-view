  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      ...
      <ActContentRender
        ...
        chapters={chapters}
        loading={loading}
        printableLawContent={printableLawContent}
...
export const TimelineComponent = (props) => {
  const { versionList, primaryColor, selectedVersion, setSelectedVersion } =
    props;
    ...
    >
      ...
      >
        <LawPrintModal
          ...
          primaryColor={primaryColor}
          chapters={chapters}
          lawContents={printableLawContent}
          selectedChapterIds={selectedChapterIds}
          setSelectedChapterIds={setSelectedChapterIds}
          backgroundImage={backgroundImage}
          onPrint={onPrint}
  ...
  return (
    <>
      <div style={{ display: "flex", flexDirection: "column", rowGap: "10px" }}>
        ...
        <Space style={{ display: "flex", flexWrap: "wrap" }}>
          <Text strong style={{ fontWeight: "bolder", color: primaryColor }}>
            Status :
          </Text>
          <Text>
            {lawMeta?.lawVersion?.isLatestVersion ? (
