...
import { Button, Checkbox, Divider, Drawer, Empty, List, Modal, notification, Select, Space, Timeline, Typography, } from 'antd';
...
export const ContentPreview = ({ contentList = [] }) => {
    return (_jsx("div", { className: "act-preview", children: contentList.map((content, index) => {
    ...
    return (_jsx(_Fragment, { children: _jsxs("div", { style: {
                ...
                transition: 'width 0.2s',
                        ...
                        bottom: '0px',
                            ...
                            }, children: "Reset" }), _jsx(Button, { type: "primary", onClick: () => {
...
export const ActContentRender = (props) => {
    ...
    return (_jsxs("div", { style: {
            ...
            borderRight: '1px solid #ccc',
                ...
                }, footer: false, width: drawerWidth, centered: true, children: _jsx(LawPrintModal, { lawMeta: lawMeta, initialState: initialState }) })] }));
};
const LawPrintModal = (props) => {
    ...
    const onPrint = async () => {
        if ((selectedChapterIds === null || selectedChapterIds === void 0 ? void 0 : selectedChapterIds.length) <= 0) {
            notification === null || notification === void 0 ? void 0 : notification.warning({
                message: 'Please select any of the Chapters to print',
            });
            return;
        }
        let tempSelectedChapterIds = selectedChapterIds === null || selectedChapterIds === void 0 ? void 0 : selectedChapterIds.join(',');
    };
    useEffect(() => { }, [lawMeta]);
    useEffect(() => {
        setLawContents([]);
